...
title: "Tools"
slug: "tools"
excerpt: "Specify tools for FarmBot's Universal Tool Mount to use [my.farm.bot/app/tools](https://my.farm.bot/app/tools)"
---
...
<div class="nav-image">
  ...
  <a href="#section-toolbay" style="top: 16.56%; left: 3.9%; width: 52.77%; height: 33.38%;"></a>
  <a href="#section-tools" style="top: 16.7%; left: 59.4%; width: 37%; height: 43.5%;"></a>
</div>
...
![empty_tools.png](empty_tools.png)



![stock_tools.png](stock_tools.png)
...
You can click the <img class="nav-image" src="current_location_button.png" alt="Use Current Location" width="5%" height="5%" /> button to fill the tool slot coordinate inputs with FarmBot's current coordinates.
