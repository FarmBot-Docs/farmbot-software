...
excerpt: "**Problem description:** I completed all steps of the [configuration process](../../FarmBot-OS/farmbot-os/configurator.md#configure-farmbot) and now I'm waiting for FarmBot to connect to the web application."
---
