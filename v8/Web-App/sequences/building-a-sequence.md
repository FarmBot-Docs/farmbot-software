...
In the **Sequences** panel, click the <span class="fb-button fb-green">:fa-plus:</span> button to create a new sequence. Or, select an existing sequence if you would like to edit it. If you have many sequences, use the search box to find one more quickly.
