...
# Hiding the widgets
If you do not plan to use any sensors, use the **HIDE SENSORS** toggle in the [app settings area](../../Web-App/the-farmbot-web-app/account-settings.md) to remove the widgets from the controls page.
