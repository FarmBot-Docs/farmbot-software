...
We also recommend [choosing a FarmBot model](../../Web-App/the-farmbot-web-app/creating-an-account.md#account-seeding) from the message center before starting configuration. This will set the correct firmware version in your web app account, allowing FarmBot to fully initialize when it connects."
%}
