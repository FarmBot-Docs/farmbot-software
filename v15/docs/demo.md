...
type="info"
content="Not all features of the app will work in demo mode because there will not be a real FarmBot connected to the account. For example, you cannot take pictures."
%}

{%
include callout.html
type="trash"
content="Demo accounts and their data are automatically deleted after 1 hour."
%}
