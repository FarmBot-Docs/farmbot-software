...
You can also take photos from [sequences](../../Web-App/sequences.md) by using the <span class="fb-step fb-take-photo">Take Photo</span> command. For more information, see the [take photo command documentation](../../Web-App/sequences/sequence-commands.md#take-photo).
