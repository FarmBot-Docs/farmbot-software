...
You can also control peripherals from [sequences](../../The FarmBot Web App/sequences.md) by using the <span class="fb-step fb-write-pin">Control Peripheral</span> command. For more information, see the [control peripheral command documentation](doc:sequence-commands#section-control-peripheral).
