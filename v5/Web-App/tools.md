...
You can click the <img class="nav-image" src="_images/current_location_button.png" alt="Use Current Location" width="50%" height="50%" /> button to fill the tool slot coordinate inputs with FarmBot's current coordinates.
