...
Ensure you have added the **TOOL VERIFICATION** sensor by checking the SENSORS list in the Sensors panel. If you do not see the sensor, add it using [these instructions](../../The-FarmBot-Web-App/sensors.md#creating-sensors).
